...
def transitionCellFinder():
    ...
    cur.execute('select id,bleft, bright,\
                btop, bbottom, Node, edge from public."facultyFinal"\
...
#    plt.show()
    ...
    conn.close()
    cur.close()
    np.savetxt('F:\Stuff\Current_Term\KNTU\papers\ISI\csvs\TransitionCellsAtr.csv', transitionCellsAtr, delimiter=',', fmt='%d')

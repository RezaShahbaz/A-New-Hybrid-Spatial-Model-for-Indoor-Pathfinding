...
def GridGraphGenerator():
    ...
    cur.execute('select distinct node from public."GridGraph"\
    ...
    for node in nodeName:
        ...
        cur.execute('select id ,centerx, centery from public."GridGraph"\
    ...
    cur.execute('select distinct edge from public."GridGraph"\
